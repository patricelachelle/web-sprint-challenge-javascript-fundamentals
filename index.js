...
// The nested function can access the variable because the variable it is calling is inside of the parent function it's nested within. 
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(names){
    ...
    arr.push(`name: ${name.animal_name}, scientific: ${name.scientific_name}`)
  ...
  */
  ...
  function lowerCaseNames() {
    return zooAnimals.map(function(name){
  ...
  */
  ...
  function lowPopulationAnimals(){
    return zooAnimals.filter(function(name){
  ...
  */
  ...
  function USApop(){
    return zooAnimals.reduce(function(accumulator, population) {
...
CuboidMaker.prototype.surfaceArea = function() {
  return Math.round(9.3 * (this.length + this.width + this.height))
}
